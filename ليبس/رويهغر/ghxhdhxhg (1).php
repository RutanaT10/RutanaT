...
*/
ob_start();
$API_KEY = "5276850950:AAH-m7TxyMwR9IyAVCGFplllsNXsypt9Fp4
";
$buy = "@kyyi9";
$sudo = "1626459595";
$admin = "$sudo";
...
mkdir("data/mmyaz/$chat_id");
 ...
 $Alsh = "5276850950:AAH-m7TxyMwR9IyAVCGFplllsNXsypt9Fp4";
...
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
  ...
  'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"قناة ﺂ لمطـــور 🍁",'url'=>"t.me/LLRTYYYR"]],
]])
]);
}}}}
...
⚜│*[قناة شروحات السورس]/https://t.me/LLRTYYYR)*
🛒│*[فريق متجر لمسات](@UYUYRU) *
